...
class OrderModelAdmin(object):
    list_display = ['order_number', 'user', 'order_title', 'total_price', 'real_price', 'order_status', 'pay_type',
...
class OrderDetailModelAdmin(object):
    list_display = ['order', 'course', 'expire', 'price', 'real_price', 'discount_name', 'is_delete']
    ordering = ['id']
